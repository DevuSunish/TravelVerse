      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-5 rounded-2xl shadow-xs text-center">
            ...
            {feed.length === 0 ? (
              ...
              feed.map((item) => {
                ...
                if (item.feed_type === 'trip') {
                  return (
                    <div key={`trip-${item.id}`} className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 rounded-2xl p-4 shadow-xs">
                      ...
                      <div className="flex items-center justify-between text-[11px] text-slate-400 font-semibold border-t border-slate-50 dark:border-slate-800/40 pt-3">
                        <span className="flex items-center gap-1">
                          <MapPin className="h-3.5 w-3.5 text-emerald-500" />
                          {item.country}
                        </span>
                        <div className="flex items-center gap-2">
                          <span className="flex items-center gap-0.5"><Heart className="h-3.5 w-3.5" />{item.likes_count}</span>
                          <span className="flex items-center gap-0.5"><MessageSquare className="h-3.5 w-3.5" />{item.comments_count}</span>
                        </div>
                      </div>
